...
export const loadPlayersFailure = createAction('[Player List] Load Players Failure', props<{ error: any }>());
...
export const removeAllFavorites = createAction('[Player List] Remove All Favorites');
